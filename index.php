...
<section class="about container">
    ...
    <div class="about__description">
        <p class="about__description__p">
            フレスコカンパニーは、北信地域を中心に施設給食事業を展開し、全国各地に向けてケータリング事業などを行う”食の専門企業”です。みなさまの笑顔をつくるあらゆる食体験を提供しています。
        </p>
    ...
    <div class="future__description__wrapper">
        ...
        <div class="future__description">
            ...
            <p class="future__description__text">
                ...
                しかし、生きるために必要なことは食事だけではありません。健康づくりや地球環境保全など人生のためのあらゆる物事を、食事を通じてよりよくしていきたい。
